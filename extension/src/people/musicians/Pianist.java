...
/**
 * Pianist class, used to play the Piano instrument.
 */
public class Pianist extends Person implements Musician {
  ...
  /**
   * Reads the score of the music that the pianist will play.
   *
   * @param notes the array of notes (integers).
   *
   * @param soft whether the pianist will play it loudly or softly.
   */
